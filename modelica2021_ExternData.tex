...
The Modelica library \modelica{ModelicaTableAdditions} developed out of the need to offer reading of external data sources for look-up tables from a commonly used text file format.
